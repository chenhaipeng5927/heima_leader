...
public interface ApArticleMapper {
 ...
 /*   String TABLE = "";
    ...
    final String COLUMN = " title, author_id, author_name, channel_id, channel_name, layout, flag, images,\n" +
     ...
     * @return
     */
    //@SelectProvider(type = Provider.class,method = "loadArticleListByLocation")
...
/*
    class Provider {
        ...
        public String loadArticleListByLocation(Map<String,Object> params){
